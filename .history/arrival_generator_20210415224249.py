...
def createArrival(width, height, code, airport):
    pos = newPos(width, height)
    start, end = newRoute(code, airport)
    return Aircraft(newCallsign(), pos, newHeading(pos, width, height), newSpeed(), newAltitude(),
                    0, start, end)

print(createArrival(123, 123))