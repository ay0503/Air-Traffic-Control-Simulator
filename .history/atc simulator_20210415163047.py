...
def appStarted(app):
    ...
    A1 = Aircraft("DAL123", [450, 330], 133, 300, 7000, 0, 'KSEA', app.aiports[0].code)
    A2 = Aircraft("BAW321", [800, 600], 233, 250, 4000, 0, 'EGLL', app.aiports[0].code)
    A3 = Aircraft("KAL434", [0, 700], 87, 250, 9000, -1000, 'RKSI', app.aiports[0].code) 
...
def drawSidebar(app, canvas):
    ...
    for row in range(min(len(app.aircrafts), 5)):
        ...
        info = f"{flight.callsign}, {flight.hdg}°, {flight.spd}kt,\n{int(flight.alt)}ft, {flight.vs}ft/m, {flight.depart} - {flight.arrival}"
