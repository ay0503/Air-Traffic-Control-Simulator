...
def addVector(x, y):
    return list(map(lambda x,y:x+y, self.beacon, normalVector(vector)) / 8
...
class Runways(object):
    ...
    def rangeILS(self):
        ...
        base = list(map(lambda x,y:x+y, self.beacon, normalVector(vector)) / 8
        p1, p2, p3 = 

L = Runways('25L', [0,0], 251, 12000)
print(L.beacon)