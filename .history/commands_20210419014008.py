...
testAirport = Airport("KLAX", [[0, -6, 83], [0, -11, 83], [0, +6, 83], [0, +11, 83]], 'F')
...
def testDivideCommand():
    ...
    assert(divideCommand("DAL123 fly heading 230 climb to 3000", testFlights, testAirport) == ('DAL123', '3000', '230', None))
    assert(divideCommand("DAL 123 descend to 2000", testFlight, testAirport) == ('DAL123', '2000', None, None))
    assert(divideCommand("Delta 3232 decelerate to 210", testFlights, testAirport) == ('DAL3232', None, None, '210'))
    assert(divideCommand("Korean Air 123 turn right heading 350", testFlights, testAirport) == ('KAL123', None, '350', None))
    assert(divideCommand("DAL123 decelerate to 200", testFlights, testAirport) == ('DAL123', None, None, "200"))
    print("Passed")
