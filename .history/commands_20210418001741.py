...
cmd = "Delta 123 turn right heading 350"
#print(divideCommand(cmd, flights))

def testDivideCommand():
    print("testing Command Recognition")
    assert(divideCommand("DAL123 fly heading 230 climb to 3000") == "DAL123", 3000, 230, None)
    assert(divideCommand("DAL 123 descend to 2000") == "DAL123", 2000, None, None)
    assert(divideCommand("Delta 3232 decelerate to 210") == "DAL123", None, None, 210)
    print("Passed")
