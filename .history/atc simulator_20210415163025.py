...
def appStarted(app):
    ...
    A1 = Aircraft("DAL123", [450, 330], 133, 300, 7000, 0, 'KSEA', app.aiports[0])
    A2 = Aircraft("BAW321", [800, 600], 233, 250, 4000, 0, 'EGLL', app.aiports[0])
    A3 = Aircraft("KAL434", [0, 700], 87, 250, 9000, -1000, 'RKSI', app.aiports[0]) 
