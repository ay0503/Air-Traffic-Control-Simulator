...
def appStarted(app):
    ...
    A2 = Aircraft("DAL123", [800, 600], 233, 250, 4000, 0)
    app.aircrafts.append(A1)
...
def drawAircraft(app, canvas, plane):
    ...
    canvas.create_line(x, y, 
                        x + 30 * hdgVector(plane.hdg, plane.spd / 200)[0],
                        y + 30 * hdgVector(plane.hdg, plane.spd / 200)[1], 
                        fill = app.color)
    # aircraft information
    canvas.create_text(x + 10, y, text = info, 
                        anchor = "w", font = "Arial 20 bold")
