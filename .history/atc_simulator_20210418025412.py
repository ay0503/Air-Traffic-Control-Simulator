...
def appStarted(app):
    ...
    app.airport = Airport("KLAX", [app.mapWidth / 2, app.mapHeight / 2],
    [], 'F')
    app.airport.runways.append([Runway('25L', [0, -6], 251, 12000, KLAX)])
...
def drawAirport(app, canvas):
    ...
    for runway in app.airport.runways:
        ...
        #TODO draw ILS wing
        canvas.create_oval(runway.beacon[0] - 10, runway.beacon[1] - 10, 
                            runway.beacon[0] + 10, runway.beacon[1] + 10,
                            fill = "white")
